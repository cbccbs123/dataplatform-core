...
CREATE TABLE IF NOT EXISTS entity (
    ...
    promoted_to UUID REFERENCES entity (entity_id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS match_candidate (
    ...
    left_asset_id  UUID NOT NULL REFERENCES asset (asset_id) ON DELETE CASCADE,
    right_asset_id UUID NOT NULL REFERENCES asset (asset_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS match_evidence (
    ...
    decision_id UUID NOT NULL REFERENCES match_decision (decision_id) ON DELETE CASCADE,
