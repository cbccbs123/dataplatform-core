...
테스트
    ...
    ``from src.portal.search_group import ...`` 로 직접 import.
"""
...
def __getattr__(name: str) -> Any:
    """패키지 속성 지연 로드(``import src.portal as P; P.group_ranked`` 형태 지원)."""
    if name == "group_ranked":
        from src.portal.search_group import group_ranked as fn
