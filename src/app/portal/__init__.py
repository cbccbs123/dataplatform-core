...
하위호환: 진입점·테스트는 ``from src.app.portal_api import app`` 을 쓰는데, ``portal_api.py`` 가 이
...
from src.app.portal import _infra, routes_admin, routes_assets, routes_review, routes_search
